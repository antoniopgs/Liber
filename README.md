...
Many fair nations with valuable laws and principles have unfortunately evolved to authoritarian regimes, through the progressive destruction of their constitution/legal code.
Therefore, the Political Ideology under the name of Conservatism has appeared. Conservatives wish to preserve laws, values and tradition.
While the author understands they come from a good place, he thinks a law should be preseved because of it's value, instead of how long it's been around.
...
So the price of citizenship could be 3 ETH per year, or 0.1 BTC per year.
Also the payments would be made either to a governmental Bitcoin or Ethereum Address, which increase safety and transparency and decrease corruption.
